...
runcmd('curl http://gateway.openfaas:8080/function/subfeature-3 -o out.txt', verbose=False)
f3 = open('out.txt')
subfeature3 = f3.read()
f3.close
...
server3_tensor = eval(subfeature3)
...
final_result = server_function3(server3_tensor)
