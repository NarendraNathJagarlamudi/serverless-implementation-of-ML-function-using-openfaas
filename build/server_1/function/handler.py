...
def handle():
    runcmd('curl http://127.0.0.1:8080/function/subfeature -o out.txt', verbose=False)
    f1 = open('out.txt')
    subfeature1 = f1.read()
    f1.close
