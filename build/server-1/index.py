...
runcmd('curl http://gateway.openfaas:8080/function/subfeature-1 -o out.txt', verbose=False)
f1 = open('out.txt')
subfeature1 = f1.read()
f1.close
...
server1_tensor = eval(subfeature1)
...
## server 1
def server_function1(subfeature1):
    server1_function = torch.load('models/server_model_part1.pt')
    server1_function.eval()
    server1_output = server1_function(subfeature1)# accept subfeature 1
    return server1_output
...
## server 3
# def server_function3(subfeature3):
#     server3_function = torch.load('models/server_model_part3.pt')
#     server3_function.eval()
#     server3_output = server3_function(subfeature3) # accept subfeature 3
#     return server3_output

# ## server 4
# def server_function4(subfeature4):
#     server4_function = torch.load('models/server_model_part4.pt')
#     server4_function.eval()
#     server4_output = server4_function(subfeature4) # accept subfeature 4
#     return server4_output
final_result = server_function1(server1_tensor)
