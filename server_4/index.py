...
runcmd('curl http://gateway.openfaas:8080/function/subfeature-4 -o out.txt', verbose=False)
f4 = open('out.txt')
subfeature4 = f4.read()
f4.close
...
server4_tensor = eval(subfeature4)
...
final_result = server_function4(server4_tensor)
